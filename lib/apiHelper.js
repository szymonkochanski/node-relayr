...
api.transmitters = function (token, tr_id, callback) {
    var options = addHeaders({
        url: base + "/transmitters/" + tr_id
    });
    request.get(options, function (err, data, body) {
        respond200(err, data, body, callback);
    });
...
api.transmitterDevices = function (token, tr_id, callback) {
    var options = addHeaders({
        url: base + "/transmitters/" + tr_id + "/devices"
    });
    request.get(options, function (err, data, body) {
        respond200(err, data, body, callback);
    });
